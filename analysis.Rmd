...
moderators <-
  ...
  transmute(
    ...
    avghrs = case_when(
      ...
      avghrs > 50 ~ "50+",
      TRUE ~ NA_character_
    ) %>% factor(levels = c("0-10", "11-20", "21-30", "31-40", "41-50", "50+"))
  )
...
```{r, results='asis'}
lm1 <- rma(yi = ES, vi = EV, data = df_d, method = "REML", mods = ~ type)
lm2 <- rma(yi = ES, vi = EV, data = df_d, method = "REML", mods = ~ type + design)
lm3 <- rma(yi = ES, vi = EV, data = df_d, method = "REML", mods = ~ type + design + control)
lm4 <- rma(yi = ES, vi = EV, data = df_d, method = "REML", mods = ~ type + design + control + grade)
lm5 <- rma(yi = ES, vi = EV, data = df_d, method = "REML", mods = ~ type + design + control + grade + avghrs)
lm6 <- rma(yi = ES, vi = EV, data = df_d, method = "REML", mods = ~ type + design + control + grade + avghrs + tech_plus1)
lm7 <- rma(yi = ES, vi = EV, data = df_d, method = "REML", mods = ~ type + design + control + grade + avghrs + tech_plus1 + typetech)
lm8 <- rma(yi = ES, vi = EV, data = df_d, method = "REML", mods = ~ type + design + control + grade + avghrs + tech_plus1 + typetech + instructional_context)
lm9 <- rma(yi = ES, vi = EV, data = df_d, method = "REML", mods = ~ type + design + control + grade + avghrs + tech_plus1 + typetech + instructional_context + pedagogy)
lm10 <- rma(yi = ES, vi = EV, data = df_d, method = "REML", mods = ~ type + design + control + grade + avghrs + tech_plus1 + typetech + instructional_context + pedagogy + gamification)
lm11 <- rma(yi = ES, vi = EV, data = df_d, method = "REML", mods = ~ type + design + control + grade + avghrs + tech_plus1 + typetech + instructional_context + pedagogy + gamification + adaptivity)
lm12 <- rma(yi = ES, vi = EV, data = df_d, method = "REML", mods = ~ type + design + control + grade + avghrs + tech_plus1 + typetech + instructional_context + pedagogy + gamification + adaptivity + feedback)

knitreg(list(lm1, lm2, lm3, lm4, lm5, lm6, lm7, lm8, lm9, lm10, lm11, lm12), stars = c(0.01, 0.05, 0.1), include.ci = FALSE, dcolumn = TRUE, booktabs = TRUE, digits = 2, caption = "")
```
...
```{r, results='asis'}
lm1 <- rma(yi = ES, vi = EV, data = df_c, method = "REML", mods = ~ type)
lm2 <- rma(yi = ES, vi = EV, data = df_c, method = "REML", mods = ~ type + design)
lm3 <- rma(yi = ES, vi = EV, data = df_c, method = "REML", mods = ~ type + design + control)
lm4 <- rma(yi = ES, vi = EV, data = df_c, method = "REML", mods = ~ type + design + control + grade)
lm5 <- rma(yi = ES, vi = EV, data = df_c, method = "REML", mods = ~ type + design + control + grade + avghrs)
lm6 <- rma(yi = ES, vi = EV, data = df_c, method = "REML", mods = ~ type + design + control + grade + avghrs + tech_plus1)
lm7 <- rma(yi = ES, vi = EV, data = df_c, method = "REML", mods = ~ type + design + control + grade + avghrs + tech_plus1 + typetech)
lm8 <- rma(yi = ES, vi = EV, data = df_c, method = "REML", mods = ~ type + design + control + grade + avghrs + tech_plus1 + typetech + instructional_context)
lm9 <- rma(yi = ES, vi = EV, data = df_c, method = "REML", mods = ~ type + design + control + grade + avghrs + tech_plus1 + typetech + instructional_context + pedagogy)
lm10 <- rma(yi = ES, vi = EV, data = df_c, method = "REML", mods = ~ type + design + control + grade + avghrs + tech_plus1 + typetech + instructional_context + pedagogy + gamification)
lm11 <- rma(yi = ES, vi = EV, data = df_c, method = "REML", mods = ~ type + design + control + grade + avghrs + tech_plus1 + typetech + instructional_context + pedagogy + gamification + adaptivity)
lm12 <- rma(yi = ES, vi = EV, data = df_c, method = "REML", mods = ~ type + design + control + grade + avghrs + tech_plus1 + typetech + instructional_context + pedagogy + gamification + adaptivity + feedback)
...
```{r, results='asis'}
lm1 <- rma(yi = ES, vi = EV, data = df_l, method = "REML", mods = ~ type)
lm2 <- rma(yi = ES, vi = EV, data = df_l, method = "REML", mods = ~ type + design)
lm3 <- rma(yi = ES, vi = EV, data = df_l, method = "REML", mods = ~ type + design + control)
lm4 <- rma(yi = ES, vi = EV, data = df_l, method = "REML", mods = ~ type + design + control + grade)
lm5 <- rma(yi = ES, vi = EV, data = df_l, method = "REML", mods = ~ type + design + control + grade + avghrs)
lm6 <- rma(yi = ES, vi = EV, data = df_l, method = "REML", mods = ~ type + design + control + grade + avghrs + tech_plus1)
lm7 <- rma(yi = ES, vi = EV, data = df_l, method = "REML", mods = ~ type + design + control + grade + avghrs + tech_plus1 + typetech)
lm8 <- rma(yi = ES, vi = EV, data = df_l, method = "REML", mods = ~ type + design + control + grade + avghrs + tech_plus1 + typetech + instructional_context)
lm9 <- rma(yi = ES, vi = EV, data = df_l, method = "REML", mods = ~ type + design + control + grade + avghrs + tech_plus1 + typetech + instructional_context + pedagogy)
lm10 <- rma(yi = ES, vi = EV, data = df_l, method = "REML", mods = ~ type + design + control + grade + avghrs + tech_plus1 + typetech + instructional_context + pedagogy + gamification)
lm11 <- rma(yi = ES, vi = EV, data = df_l, method = "REML", mods = ~ type + design + control + grade + avghrs + tech_plus1 + typetech + instructional_context + pedagogy + gamification + adaptivity)
lm12 <- rma(yi = ES, vi = EV, data = df_l, method = "REML", mods = ~ type + design + control + grade + avghrs + tech_plus1 + typetech + instructional_context + pedagogy + gamification + adaptivity + feedback)
